...
@WebServlet("/controlador_calificacionNegativa")
public class controlador_calificacionNegativa extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean resultado = objeto.NoMeGusta(usuario, articulo);
		if(resultado) {
